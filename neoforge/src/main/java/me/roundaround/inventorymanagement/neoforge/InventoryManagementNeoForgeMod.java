...
public final class InventoryManagementNeoForgeMod {
    public InventoryManagementNeoForgeMod(IEventBus modBus, ModContainer container) {
        ...
        modBus.addListener(FMLClientSetupEvent.class, event -> {
            // Client-only so single-player locks (world-scoped store) subscribe to the world-dir
            // lifecycle; a dedicated server never runs this, so it never writes a stray locks file.
