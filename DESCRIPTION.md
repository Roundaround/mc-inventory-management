...
<details>
<summary><b>Every configuration option</b></summary>
...
<details>
<summary><b>Modifying the button positions</b></summary>
...
<details>
<summary><b>Locked slots</b></summary>
...
<details>
<summary><b>Hotbar swapping</b></summary>
...
<details>
<summary><b>Item durability</b></summary>
...
<details>
<summary><b>Item grouping</b></summary>
...
Inventory Management exposes a small, loader-agnostic API for contributing your own item **variant groups** and **sort comparators**, plus a datapack convention that needs no code at all — any item tag whose path starts with `grouping/` becomes a variant family automatically.

The full reference (factory tables, priority rules, registration timing, and worked examples) lives with the source:

**[Mod and pack developer documentation on GitHub →](https://github.com/Roundaround/mc-inventory-management#for-mod-and-pack-developers)**

## Links

<!-- modrinth:only -->
Also on [CurseForge](https://www.curseforge.com/minecraft/mc-mods/inventory-management) · [Source on GitHub](https://github.com/Roundaround/mc-inventory-management) · [Report an issue](https://github.com/Roundaround/mc-inventory-management/issues)
<!-- /modrinth:only -->
<!-- curseforge:only -->
Also on [Modrinth](https://modrinth.com/mod/inventory-management) · [Source on GitHub](https://github.com/Roundaround/mc-inventory-management) · [Report an issue](https://github.com/Roundaround/mc-inventory-management/issues)
<!-- /curseforge:only -->
